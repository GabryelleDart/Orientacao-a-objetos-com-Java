package ExemploProdutosEmEstoque.Application;
import java.util.Locale;
import java.util.Scanner;
import ExemploProdutosEmEstoque.Entities.Product;
...
public class Main {
    public static void main(String[] args) {
        ...
        one.nome= sc.nextLine();
        System.out.println("Insira o preço do produto:");
        one.preço= sc.nextDouble();
        System.out.println("Insira a quantidade do produto em estoque:");
        one.quantidade=sc.nextInt();
        sc.nextLine();
